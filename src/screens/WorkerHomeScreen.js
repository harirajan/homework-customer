    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.availabilityCard}>
        <View>
          ...
          <Text style={styles.availabilitySubtitle}>
            {profile?.available ? 'You are visible to customers' : 'You are hidden from customers'}
          </Text>
        </View>
        <Switch
      ...
      <View style={styles.statsRow}>
        <View style={styles.statCard}>
          <Text style={styles.statValue}>⭐ {profile?.averageRating ? profile.averageRating.toFixed(1) : 'New'}</Text>
...
const styles = StyleSheet.create({
  ...
  availabilitySubtitle: { fontSize: 13, color: '#6B7280', marginTop: 4, maxWidth: 220 },
  statsRow: {
    flexDirection: 'row',
